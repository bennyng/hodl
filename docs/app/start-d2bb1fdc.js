var t = Object.defineProperty,
  ...
  i = (t, e) => {
    ...
    if (s) for (var r of s(e)) o.call(e, r) && a(t, r, e[r]);
    return t;
  };
import {
  S as l,
  ...
  B as N,
  C,
} from "./chunks/vendor-4a096402.js";
function I(t) {
  let e, r, s;
  const n = [t[2] || {}];
  var o = t[0][1];
  ...
  return (
    o && (e = new o(a(t))),
    {
      ...
      p(t, s) {
        ...
        if (
          (521 & s && (i.$$scope = { dirty: s, ctx: t }), o !== (o = t[0][1]))
        ) {
          if (e) {
            N();
            const t = e;
  ...
  return {
    ...
    p(t, r) {
      t[0][1]
        ? s
          ? (s.p(t, r), 1 & r && O(s, 1))
          : ((s = I(t)), s.c(), O(s, 1), s.m(e.parentNode, e))
        : s &&
          (N(),
          L(s, 1, 1, () => {
            s = null;
...
function z(t) {
  ...
  return {
    c() {
      e && b(e.$$.fragment), (r = $()), l && l.c(), (s = w());
    },
    l(t) {
      e && x(e.$$.fragment, t), (r = E(t)), l && l.l(t), (s = w());
    },
    m(t, o) {
      e && q(e, t, o), m(t, r, o), l && l.m(t, o), m(t, s, o), (n = !0);
    },
    p(t, [n]) {
      const c = 2 & n ? R(o, [S(t[1] || {})]) : {};
      if (
        (525 & n && (c.$$scope = { dirty: n, ctx: t }), a !== (a = t[0][0]))
      ) {
        if (e) {
          N();
          const t = e;
    ...
    o(t) {
      e && L(e.$$.fragment, t), (n = !1);
    },
    d(t) {
      e && U(e, t), t && f(r), l && l.d(t), t && f(s);
    },
  };
}
function M(t, e, r) {
  let { stores: s } = e,
    ...
    { props_1: i = null } = e,
    { props_2: l = null } = e;
  P("__svelte__", s), j(s.page.notify);
  let c = !1,
    u = !1,
    h = null;
  return (
...
const J = {},
  ...
  F = [
    () =>
      X(
        () => import("./layout.svelte-3c0c98f9.js"),
        ["/app/layout.svelte-3c0c98f9.js", "/app/chunks/vendor-4a096402.js"]
      ),
    () =>
      X(
        () => import("./error.svelte-0a0df95e.js"),
        ["/app/error.svelte-0a0df95e.js", "/app/chunks/vendor-4a096402.js"]
      ),
    () =>
      X(
        () => import("./pages/index.svelte-cebeb237.js"),
        [
          "/app/pages/index.svelte-cebeb237.js",
          "/app/chunks/vendor-4a096402.js",
        ]
      ),
  ],
  H = [[/^\/$/, [F[0], F[2]], [F[1]]]],
...
class et {
  ...
  init(t) {
    ...
    addEventListener("touchstart", n),
      ...
      addEventListener("click", (t) => {
        ...
        const o = null == (e = r.getAttribute("rel")) ? void 0 : e.split(/\s+/);
        if (r.hasAttribute("download") || (o && o.includes("external"))) return;
        if (s ? r.target.baseVal : r.target) return;
        const a = new URL(n);
        if (!this.owns(a)) return;
        const i = r.hasAttribute("sveltekit:noscroll");
        history.pushState({}, "", a.href),
          this._navigate(a, i ? Z() : null, [], a.hash),
          t.preventDefault();
      }),
  ...
  async goto(
    t,
    { noscroll: e = !1, replaceState: r = !1, state: s = {} } = {},
    n
  ) {
    const o = new URL(
      t,
    ...
    return this.enabled && this.owns(o)
      ? (history[r ? "replaceState" : "pushState"](s, "", t),
        this._navigate(o, e ? Z() : null, n, o.hash))
...
function st(t, e) {
  let r = `script[type="svelte-data"][url="${
...
class nt {
  ...
  async start({ status: t, error: e, nodes: r, page: s }) {
    ...
    try {
      for (let o = 0; o < r.length; o += 1) {
        ...
        if ((n.push(h), h && h.loaded))
          if (h.loaded.error) {
            if (e) throw h.loaded.error;
            (a = h.loaded.status), (l = h.loaded.error);
          } else h.loaded.context && (c = i(i({}, c), h.loaded.context));
      }
      o = await this._get_navigation_result_from_branch({ page: s, branch: n });
    } catch (u) {
      if (e) throw u;
      (a = 500), (l = u);
    }
  ...
  async _get_navigation_result_from_branch({ page: t, branch: e }) {
    ...
    for (let a = 0; a < r.length; a += 1)
      r[a].loaded && (s.props[`props_${a}`] = await r[a].loaded.props);
    (this.current.page &&
    ...
    if (o) {
      ...
      let r = !1;
      const n = () => {
          this.cache.get(e) === s && this.cache.delete(e), i(), clearTimeout(a);
        },
    ...
    if (r.load) {
      const { started: c } = this,
        u = {
          ...
          get context() {
            return (o.uses.context = !0), i({}, n);
          },
          fetch(t, e) {
            const r = "string" == typeof t ? t : t.url,
              { href: n } = new URL(r, new URL(s.path, document.baseURI));
            return o.uses.dependencies.push(n), c ? fetch(t, e) : st(t, e);
          },
        };
...
async function ot({
  ...
  const l = n && new et({ base: t.base, routes: H, trailing_slash: a }),
    c = new nt({ Root: Y, fallback: Q, target: e, session: r, host: s });
  i && (await c.start(i)),
    n && l.init(c),
